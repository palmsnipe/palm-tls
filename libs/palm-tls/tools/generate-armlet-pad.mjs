 ...
 * and a two-byte gap before resource data. The ARM PRC contains libr:0, the
 * selected five-resource protocol engines, PadR:1, and armc:1. build-prc sorts
 * PadR and Tls resources before armc, so their sizes determine armc alignment. */
const resourceCount = 3 + resources.length;
