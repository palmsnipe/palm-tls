...
#define XREALLOC(pointer, size, heap, type)      WolfPalmRealloc((pointer), (unsigned long)(size))
...
#define NO_OLD_TLS
#endif
#if !defined(PALM_WOLFSSL_TLS12_ONLY) &&      !defined(PALM_WOLFSSL_TLS11_ONLY)
...
#if defined(PALM_WOLFSSL_ENABLE_ARMLET_MATH) ||      defined(PALM_WOLFSSL_TLS11_ONLY)
